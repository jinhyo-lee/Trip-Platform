...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>    
	...
	<c:set var="detail" value="${foodReviewDetail}"/>
	<form class="needs-validation"  id="reviewFormValue" enctype="multipart/form-data" name="form" method="post" action="foodReviewModify">
		<input type="hidden" name="id" value="${sessionScope.id }">
		<input type="hidden" name="food_rev_id" value="${food_rev_id }">
