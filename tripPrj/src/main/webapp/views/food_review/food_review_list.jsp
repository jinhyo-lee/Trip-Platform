	...
	<div class="row">
		<div class="tab-content col-md-7 mb-md-0 mb-4">
			<div class="tab-pane fade show active" id="review-list" role="tabpanel">
				...
				<!-- Review list -->
				<c:forEach var="foodReview" items="${reviewlist}" varStatus="status">
				<div class="mb-4 pb-4 border-bottom">
					<div class="d-flex justify-content-between mb-3">
						...
						<div class="d-inline-block">
							...
							<span class="text-muted fs-sm">
								<button style="padding: 0;" type="button" class="btn btn-link btn-sm" title="좋아요 추가" onclick="location.href='foodReviewLike?food_rev_id=${foodReview.food_rev_id}&food_id=${food.food_id}&page=${page}&state=cont'">
							...
							<span class="text-muted fs-sm">
								<button style="padding: 0;" type="button" class="btn btn-link btn-sm" title="좋아요 삭제" onclick="location.href='foodReviewLike?food_rev_id=${foodReview.food_rev_id}&food_id=${food.food_id}&page=${page}&state=cont'">
							...
							<div class="dropdown d-inline-block" style="float: right;">
								...
								<div class="dropdown-menu dropdown-menu-end my-1">
									<button class="btn btn-link btn-sm" type="button" href="#modal-reply" data-bs-toggle="modal" onclick="reply(${foodReview.food_rev_id },${page },${foodReview.food_id })">
					...
					<a class="collapse-label collapsed" href="#seeMoreOverview_rep${foodReview.food_rev_id}" data-bs-toggle="collapse" data-bs-label-collapsed="댓글 보기" data-bs-label-expanded="접기" role="button" aria-expanded="false" aria-controls="seeMoreOverview"
						onclick="replyList(${foodReview.food_rev_id },${food_id },${page })"></a>
					<!-- Reply List -->
					<div class="collapse" id="seeMoreOverview_rep${foodReview.food_rev_id}">
						<!-- load area -->
					</div>
				</div>
				</c:forEach>
			...
			<%@ include file="../food_qna/food_qna_list.jsp"%>
			</div>
		</div>
	</div>
</section>