        ...
        <div class="row">
          ...
          <div class="col-lg-8">
            ...
            <section class="card card-body border-0 shadow-sm p-4 mb-4" id="basic-info">
              ...
              <div class="col-sm-6 mb-3">
                ...
                <select class="form-select" id="room_type" name="room_type" value="${room.room_type}" required>
                  ...
                  <option value="호텔" <c:if test="${room.room_type == '호텔'}">${'selected'} </c:if>>호텔</option>
                  <option value="콘도" <c:if test="${room.room_type == '콘도'}">${'selected'} </c:if>>콘도</option>
                  <option value="리조트" <c:if test="${room.room_type == '리조트'}">${'selected'} </c:if>>리조트</option>
                  <option value="캠핑장" <c:if test="${room.room_type == '캠핑장'}">${'selected'} </c:if>>캠핑장</option>
                  <option value="게스트하우스" <c:if test="${room.room_type == '게스트하우스'}">${'selected'} </c:if>>게스트하우스</option>
                  <option value="기타" <c:if test="${room.room_type == '기타'}">${'selected'} </c:if>>기타</option>
                </select>
              </div>
          	  <!-- Contacts-->
              <div class="col-sm-6 mb-3">
              ...
              <div class="col-sm-6 mb-3">
                ...
                <input class="form-control" type="text" id="room_cost" name="room_cost" value="${room.room_cost}" placeholder="가격대를 입력하세요" required>
              </div>
            </section>
            <!-- Photos-->
            <section class="card card-body border-0 shadow-sm p-4 mb-4" enctype="multipart/form-data" >
              ...
              <input type="file" id="room_photos" name="room_photos" value="${room.room_photo}" multiple>
            </section>
