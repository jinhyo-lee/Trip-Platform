...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Room Write</title>
    <script src="http://code.jquery.com/jquery-latest.js"></script>
	<script src="func/room_write.js"></script>
    <!-- Viewport-->
  ...
  <body class="bg-secondary">
    ...
    <main class="page-wrapper">
      ...
      <div class="container mt-5 mb-md-4 py-5">
        <div class="row">
          <!-- Page content-->
          <form enctype="multipart/form-data" action="roomWrite" method="post">
          <div class="col-lg-8">
            <!-- Breadcrumb-->
            ...
            <section class="card card-body border-0 shadow-sm p-4 mb-4" id="basic-info">
              <h2 class="h4 mb-4"><i class="fi-info-circle text-primary fs-5 mt-n1 me-2"></i>정보</h2>
                <div class="col-sm-6 mb-3">
                  ...
                  <input class="form-control" type="text" id="room_name" name="room_name" placeholder="숙소 이름을 입력하세요" required><span class="form-text"></span>
                </div>
                <div class="col-sm-6 mb-3">
                  <label class="form-label" for="ab-title">옵션<span class="text-danger">*</span></label>
                  <input class="form-control" id="room_option" name="room_option" placeholder="숙소 옵션을 입력하세요" required><span class="form-text"></span>
                </div>
                <div class="col-sm-6 mb-3">
                ...
                <div class="col-sm-6 mb-3">
                  ...
                  <input class="form-control" type="tel" id="room_tel" name="room_tel" placeholder="연락처를 입력하세요 (-제외)" required>
                </div>
                <div class="col-sm-6 mb-3">
                  <label class="form-label" for="ab-title">주소 <span class="text-danger">*</span></label>
                  <input class="form-control" type="text" id="room_addr" name="room_addr" placeholder="주소를 입력하세요" required>
                </div>
                <!-- Content-->
                <label class="form-label" for="ab-description">소개<span class="text-danger">*</span></label>
                <div class="row mb-4">
                  <div class="col-md-9 mb-md-0 mb-3">
                    <textarea class="form-control" id="room_content" name="room_content" rows="6" placeholder="소개를 입력하세요"></textarea><span class="form-text"></span>
                  </div>
                </div>
                <!-- Rank-->
                <div class="col-sm-6 mb-3">
                  <label class="form-label" for="ab-title">성급<span class="text-danger">*</span></label>
                  <select class="form-select" id="room_star" name="room_star" required>
                ...
                <div class="col-sm-6 mb-3">
                  ...
                  <input class="form-control" type="text" id="room_cost" name="room_cost" placeholder="가격대를 입력하세요" required>
                </div>
            </section>
            <!-- Photos-->
