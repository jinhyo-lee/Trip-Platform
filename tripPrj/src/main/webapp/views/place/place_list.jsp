            ...
            <div class="col-lg-12">
              ...
              <div class="row g-4 py-4">
                ...
                <article class="card card-horizontal border-0 mb-4">
                  ...
                  <c:if test="${page == '1' && status.count <= '3'}">
                  <span class="badge bg-info position-absolute top-0 end-0 m-3 fs-sm">New</span>
                  </c:if></a>
                  <div class="card-body px-0 pt-0 pb-lg-5 pb-sm-4 pb-2"><a class="fs-sm text-uppercase text-decoration-none" href="#">${place.place_act } / ${place.place_type }</a>
