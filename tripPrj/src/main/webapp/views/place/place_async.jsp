          ...
          <div class="col-lg-12">
            ...
            <c:forEach var="place" items="${placeList }">
              <article class="card card-horizontal border-0 mb-4">
                <a class="card-img-top position-relative rounded-3 me-sm-4 mb-sm-0 mb-3" href="placeDetail?place_id=${place.place_id}&page=${page}&state=cont">
                ...
                <div class="card-body px-0 pt-0 pb-lg-5 pb-sm-4 pb-2"><a class="fs-sm text-uppercase text-decoration-none" href="#">${place.place_type } / ${place.place_act }</a>
                  ...
                  <p class="fs-sm text-muted">${place.place_content }</p>
                  <a class="d-flex align-items-center text-decoration-none" href="#">
                    <div class="ps-2">
                      <div class="d-flex text-body fs-xs">
	                  	<span class="me-2 pe-1"><i class="fi-calendar-alt opacity-70 mt-n1 me-1 align-middle"></i>${place.place_hour }</span>
	                  	<span><i class="fi-star opacity-70 mt-n1 me-1 align-middle"></i>${place.place_rate }점</span>
                      </div><br>
                      <div class="d-flex text-body fs-xs">
                      	<span class="me-2 pe-1"><i class="fi-map opacity-70 mt-n1 me-1 align-middle"></i>${place.place_addr }</span>
                      </div>
                    </div></a>
                </div>
              </article>
            ...
            <nav class="border-top pb-md-4 pt-4 mt-2" aria-label="Pagination">
              <ul class="pagination mb-1">
                ...
                <li class="page-item"><a class="page-link" onclick="placeFilterPage(${startPage-10 })" aria-label="Next"><i class="fi-chevron-left"></i></a></li>
                </c:if>
                <!-- First page -->
                <c:if test="${page != 1 && startPage != 1}">
                <li class="page-item d-none d-sm-block"><a class="page-link" onclick="placeFilterPage(1)">1</a></li>
                ...
                <li class="page-item d-none d-sm-block">...</li>
                <li class="page-item d-none d-sm-block"><a class="page-link" onclick="placeFilterPage(${pageCount})">${pageCount}</a></li>
                </c:if>
                <!-- Next block -->
                <c:if test="${endPage < pageCount}">
                <li class="page-item"><a class="page-link" onclick="placeFilterPage(${startPage+10 })" aria-label="Next"><i class="fi-chevron-right"></i></a></li>
                </c:if>
              </ul>
            </nav>
            </c:if>
