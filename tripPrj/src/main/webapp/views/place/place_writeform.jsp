            ...
            <section class="card card-body border-0 shadow-sm p-4 mb-4" id="basic-info">
              <h2 class="h4 mb-4"><i class="fi-info-circle text-primary fs-5 mt-n1 me-2"></i>정보</h2>
                <div class="col-sm-6 mb-3">
                  ...
                  <input class="form-control" type="text" id="place_name" name="place_name" placeholder="명소 이름을 입력하세요" required><span class="form-text"></span>
                </div>
                <div class="col-sm-6 mb-3">
                ...
                <div class="col-sm-6 mb-3">
                  ...
                  <select class="form-select" id="place_type" name="place_type" required>
                    ...
                    <option value="궁궐">궁궐</option>
                    <option value="미술관">미술관</option>
                    <option value="박물관">박물관</option>
                    <option value="지역명소">지역명소</option>
                    <option value="수목원">수목원</option>
                ...
                <div class="col-sm-6 mb-3">
                  ...
                  <input class="form-control" type="tel" id="place_tel" name="place_tel" placeholder="연락처를 입력하세요" required>
                </div>
                <div class="col-sm-6 mb-3">
                  <label class="form-label" for="ab-title">주소 <span class="text-danger">*</span></label>
                  <input class="form-control" type="text" id="place_addr" name="place_addr" placeholder="주소를 입력하세요" required>
                </div>
                <!-- Content-->
                <label class="form-label" for="ab-description">소개<span class="text-danger">*</span></label>
                <div class="row mb-4">
                  <div class="col-md-9 mb-md-0 mb-3">
                    <textarea class="form-control" id="place_content" name="place_content" rows="6" placeholder="소개를 입력하세요">이동안내, 웹사이트</textarea><span class="form-text"></span>
                  </div>
                </div>
                <!-- Hour-->
                <div class="col-sm-6 mb-3">
