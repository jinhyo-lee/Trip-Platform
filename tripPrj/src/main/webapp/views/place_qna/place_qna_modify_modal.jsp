...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>    
	...
	<c:set var="detail" value="${placeQnaDetail}"/>
	<form class="needs-validation"  id="qnaFormValue" name="form" method="post" action="placeQnaModify">
		<input type="hidden" name="id" value="${sessionScope.id }">
		<input type="hidden" name="place_qna_id" value="${place_qna_id }">
