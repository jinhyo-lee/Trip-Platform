...
<c:when test="${!empty sessionScope.id && !empty member && empty member.profile}">
	...
	<c:if test="${!empty sessionScope.id && isMain != true && !empty placeList }"> 
    	<a class="btn btn-primary btn-sm ms-2 order-lg-3" href="#"><i class="fi-plus me-2"></i>글쓰기</a>
    </c:if>
	<c:if test="${!empty sessionScope.id && isMain != true && !empty foodList }"> 
    	<a class="btn btn-primary btn-sm ms-2 order-lg-3" href="#"><i class="fi-plus me-2"></i>글쓰기</a>
    </c:if>
    <c:if test="${!empty sessionScope.id && isMain != true && !empty roomList }"> 
    	<a class="btn btn-primary btn-sm ms-2 order-lg-3" href="#"><i class="fi-plus me-2"></i>글쓰기</a>
    </c:if>
