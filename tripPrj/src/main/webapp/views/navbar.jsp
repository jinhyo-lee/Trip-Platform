...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
	...
	<header class="navbar navbar-expand-lg navbar-light fixed-top" data-scroll-header>
  	<div class="container"><a class="navbar-brand me-3 me-xl-4" href="main"><i class="fi-map me-2">&ensp;<b>My Seoul Trip</b></i></a>
	<c:choose>
    ...
    <div class="dropdown d-none d-lg-block order-lg-3 my-n2 me-3"><a class="d-block py-2" href="myPage"><img class="rounded-circle" src="upload/${member.profile }" width="40"></a>
      <div class="dropdown-menu dropdown-menu-end">
        <div class="d-flex align-items-start border-bottom px-3 py-1 mb-2" style="width: 16rem;"><img class="rounded-circle" src="upload/${member.profile }" width="48"> 
          <div class="ps-2">
        ...
        <a class="dropdown-item" href="myBookmarkList"><i class="fi-bookmark opacity-60 me-2"></i>북마크</a>
        <a class="dropdown-item" href="myReviewList"><i class="fi-star opacity-60 me-2"></i>리뷰</a>
        <a class="dropdown-item" href="myQnaList"><i class="fi-help opacity-60 me-2"></i>Q&A</a>
    ...
    <div class="collapse navbar-collapse order-lg-2" id="navbarUserNav">
      <ul class="navbar-nav">
        <li class="nav-item"><a href="placeList" class="nav-link">명소</a></li>
        <li class="nav-item"><a href="foodList" class="nav-link">식당</a></li>
        <li class="nav-item"><a href="roomList" class="nav-link">숙소</a></li>
      </ul>
    </div>
  </div>
</header>