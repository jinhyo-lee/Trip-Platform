    ...
    <main class="page-wrapper">
      ...
      <section class="container py-5 mt-5 mb-lg-3">
        <div class="row align-items-center mt-md-2">
          <div class="col-lg-7 order-lg-2 mb-lg-0 mb-4 pb-2 pb-lg-0"><img class="d-block mx-auto" src="upload/seoul.jpg" width="746" alt="Hero image"></div>
          <div class="col-lg-5 order-lg-1 pe-lg-0">
            <h1 class="display-5 mb-4 me-lg-n5 text-lg-start text-center mb-4">My Seoul Trip</h1>
            <p class="text-lg-start text-center mb-4 mb-lg-5 fs-lg"><b>서울 곳곳의 가 볼 만한 곳을 소개합니다.</b></p>
            <!-- Search form-->
            <div class="me-lg-n5">
              <form class="form-group d-block d-md-flex position-relative rounded-md-pill me-lg-n5" action="search">
                <div class="input-group input-group-lg border-end-md"><span class="input-group-text text-muted rounded-pill ps-3"></span>
                  <input class="form-control" type="text" name="input" placeholder="어디로 가시나요?">
                </div>
                <hr class="d-md-none my-2">
                <div class="d-sm-flex">
                  <button class="btn btn-primary btn-icon rounded-circle ms-sm-3" type="submit"><i class="fi-search"></i></button>
                </div>
              </form>
            </div>
          </div>
      ...
      <section class="container mb-sm-5 mb-4 pb-lg-4">
        ...
        <div class="tns-carousel-wrapper tns-controls-outside-xxl tns-nav-outside">
          <div class="tns-carousel-inner" data-carousel-options="{&quot;items&quot;: 3, &quot;gutter&quot;: 24, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1,&quot;nav&quot;:true},&quot;500&quot;:{&quot;items&quot;:2},&quot;850&quot;:{&quot;items&quot;:3},&quot;1400&quot;:{&quot;items&quot;:3,&quot;nav&quot;:false}}}">
            ...
            <a class="d-block rounded-3 overflow-hidden" href="placeDetail?place_id=${place.place_id}&page=1&state=cont">
            <img class="d-block" src="upload/${photo}" alt="Image" style="width: 480px; height: 250px;"></a>
            </c:forTokens>
              <div class="py-3"><a class="fs-xs text-uppercase text-decoration-none" href="#">${place.place_act}</a>
                <h3 class="fs-base pt-1"><a class="nav-link" href="placeDetail?place_id=${place.place_id}&page=1&state=cont">${place.place_name}</a></h3>
                  <div class="ps-2">
                    ...
                    <div class="d-flex fs-xs opacity-60"><span class="me-2 pe-1"><i class="fi-alarm me-1"></i>${place.place_hour}</span><span><i class="fi-star me-1"></i>${place.place_rate}점</span></div>
                  </div>
              </div>
            </article>
            </c:forEach>
        ...
        <div class="tns-carousel-wrapper tns-nav-outside tns-nav-outside-flush mx-n2">
          <div class="tns-carousel-inner row gx-4 mx-0" data-carousel-options="{&quot;nav&quot;: false, &quot;autoHeight&quot;: true, &quot;controlsContainer&quot;: &quot;#carousel-controls-tp&quot;, &quot;responsive&quot;: {&quot;0&quot;:{&quot;items&quot;:1},&quot;1320&quot;:{&quot;items&quot;:2}}}">
            ...
            <div class="col">
              <div class="row gy-md-0 gy-sm-4 gy-3 gx-sm-4 gx-0">
                ...
                <div class="col-md-7" style="width:380px; height: 410px;"><a class="text-decoration-none text-light card bg-size-cover bg-position-center border-0 overflow-hidden h-100" href="foodDetail?food_id=${food[0].food_id}&page=1&state=cont" style="background-image: url(upload/${photo}); min-height: 18.75rem;"><span class="img-gradient-overlay"></span>
                ...
                <div class="col-md-5"><a class="card border-0 overflow-hidden mb-sm-4 mb-3 text-decoration-none text-light" href="foodDetail?food_id=${food[1].food_id}&page=1&state=cont">
                  <c:forTokens var="photo" items="${food[1].food_photo}" delims="," begin="0" end="0">
	              <div class="card-body p-0 position-relative"><img src="upload/${photo}" alt="Article image" style="width:280px; height: 193px"><span class="img-gradient-overlay zindex-1"></span>
	            ...
	            <a class="card border-0 overflow-hidden text-decoration-none text-light" href="foodDetail?food_id=${food[2].food_id}&page=1&state=cont">
          ...
          <div class="col">
            <div class="row gy-md-0 gy-sm-4 gy-3 gx-sm-4 gx-0">
             ...
             <div class="col-md-7" style="width:380px; height: 410px;"><a class="text-decoration-none text-light card bg-size-cover bg-position-center border-0 overflow-hidden h-100" href="foodDetail?food_id=${food[3].food_id}&page=1&state=cont" style="background-image: url(upload/${photo}); min-height: 18.75rem;"><span class="img-gradient-overlay"></span>
                 <div class="card-body content-overlay pb-0"></div>
                 <div class="card-footer content-overlay border-0 pt-0 pb-4">
                   <div class="d-sm-flex justify-content-between align-items-end pt-5 mt-2 mt-sm-5">
                     <div class="pe-2">
             ...
             <div class="col-md-5"><a class="card border-0 overflow-hidden mb-sm-4 mb-3 text-decoration-none text-light" href="foodDetail?food_id=${food[4].food_id}&page=1&state=cont">
                ...
                <a class="card border-0 overflow-hidden text-decoration-none text-light" href="foodDetail?food_id=${food[5].food_id}&page=1&state=cont">
          ...
          <div class="col">
            ...
            <div class="col-md-7" style="width:380px; height: 410px;"><a class="text-decoration-none text-light card bg-size-cover bg-position-center border-0 overflow-hidden h-100" href="foodDetail?food_id=${food[6].food_id}&page=1&state=cont" style="background-image: url(upload/${photo}); min-height: 18.75rem;"><span class="img-gradient-overlay"></span>
              <div class="card-body content-overlay pb-0"></div>
              <div class="card-footer content-overlay border-0 pt-0 pb-4">
                <div class="d-sm-flex justify-content-between align-items-end pt-5 mt-2 mt-sm-5">
                  <div class="pe-2">
            ...
            <div class="col-md-5"><a class="card border-0 overflow-hidden mb-sm-4 mb-3 text-decoration-none text-light" href="foodDetail?food_id=${food[7].food_id}&page=1&state=cont">
              ...
              </c:forTokens></a><a class="card border-0 overflow-hidden text-decoration-none text-light" href="foodDetail?food_id=${food[8].food_id}&page=1&state=cont">
          ...
          <div class="col">
            <div class="row gy-md-0 gy-sm-4 gy-3 gx-sm-4 gx-0">
             <c:forTokens var="photo" items="${food[9].food_photo}" delims="," begin="0" end="0">
              <div class="col-md-7" style="width:380px; height: 410px;"><a class="text-decoration-none text-light card bg-size-cover bg-position-center border-0 overflow-hidden h-100" href="foodDetail?food_id=${food[9].food_id}&page=1&state=cont" style="background-image: url(upload/${photo}); min-height: 18.75rem;"><span class="img-gradient-overlay"></span>
                <div class="card-body content-overlay pb-0"></div>
                <div class="card-footer content-overlay border-0 pt-0 pb-4">
                  <div class="d-sm-flex justify-content-between align-items-end pt-5 mt-2 mt-sm-5">
                    <div class="pe-2">
              ...
              <div class="col-md-5"><a class="card border-0 overflow-hidden mb-sm-4 mb-3 text-decoration-none text-light" href="foodDetail?food_id=${food[10].food_id}&page=1&state=cont">
                ...
                </c:forTokens></a><a class="card border-0 overflow-hidden text-decoration-none text-light" href="foodDetail?food_id=${food[11].food_id}&page=1&state=cont">
          ...
          <div class="col">
            <div class="card shadow-sm card-hover border-0 h-100">
              <div class="card-img-top card-img-hover"><a class="img-overlay" href="roomDetail?room_id=${room.room_id}&page=1&state=cont"></a>
                ...
                <img src="<%=request.getContextPath()%>/upload/${photo}" alt="Image" style="width:400px; height: 180px;">
                </c:forTokens>
              </div>
              ...
              <div class="card-footer d-flex align-items-center justify-content-center mx-3 pt-3 text-nowrap">
                <span class="d-inline-block mx-1 fs-sm"><i class="fi-info-circle ms-1 mt-n1 fs-lg text-muted"></i>&nbsp;${room.room_option }</span>
