...
<html lang="en">
  <head>
    ...
    <script src="func/food_write.js"></script>
    <!-- Viewport-->
  ...
  <body class="bg-secondary">
    ...
    <main class="page-wrapper">
      ...
      <div class="container mt-5 mb-md-4 py-5">
        <div class="row">
          <!-- Page content-->
          <form enctype="multipart/form-data" action="foodWrite" method="post">
          <div class="col-lg-8">
            <!-- Breadcrumb-->
            ...
            <section class="card card-body border-0 shadow-sm p-4 mb-4" id="basic-info">
              <h2 class="h4 mb-4"><i class="fi-info-circle text-primary fs-5 mt-n1 me-2"></i>정보</h2>
                <div class="col-sm-6 mb-3">
                  ...
                  <input class="form-control" type="text" id="food_name" name="food_name" placeholder="식당 이름을 입력하세요" required><span class="form-text"></span>
                </div>
              <div class="col-sm-6 mb-3">
                ...
                <select class="form-select" id="food_type" name="food_type" required>
                  ...
                  <option value="이국식당">이국식당</option>
                  <option value="해산물집">해산물집</option>
              ...
              <div class="col-sm-6 mb-3">
                ...
                <select class="form-select" id="food_feat" name="food_feat" required>
                  ...
                  <option value="멕시칸음식">멕시칸음식</option>
              ...
              <div class="col-sm-6 mb-3">
                ...
                <input class="form-control" type="menu" id="food_menu" name="food_menu" placeholder="대표 메뉴를 입력하세요" required>
               </div>
            	<!-- Contacts-->
                <div class="col-sm-6 mb-3">
                  <label class="form-label" for="ab-phone">연락처 <span class="text-danger">*</span></label>
                  <input class="form-control" type="tel" id="food_tel" name="food_tel" placeholder="연락처를 입력하세요" required>
                </div>
                <div class="col-sm-6 mb-3">
                  <label class="form-label" for="ab-title">주소 <span class="text-danger">*</span></label>
                  <input class="form-control" type="text" id="food_addr" name="food_addr" placeholder="주소를 입력하세요" required>
                </div>
              <!-- Content-->
              <label class="form-label" for="ab-description">소개 <span class="text-danger">*</span></label>
              <div class="row mb-4">
                <div class="col-md-9 mb-md-0 mb-3">
                  <textarea class="form-control" id="food_content" name="food_content" rows="6" placeholder="소개를 입력하세요" required>이동안내, 웹사이트</textarea><span class="form-text"></span>
                </div>
              </div>
                <!-- Hour-->
                <div class="col-sm-6 mb-3">
              ...
              <!-- Price-->
               <div class="col-sm-6 mb-3">
                  ...
                  <input class="form-control" type="text" id="food_cost" name="food_cost" placeholder="가격대를 입력하세요" required>
                </div>
            </section>
            <!-- Photos-->
            <section class="card card-body border-0 shadow-sm p-4 mb-4" enctype="multipart/form-data" >
              ...
              <input type="file" id="foodPhotos" name="foodPhotos" multiple>
            </section>
