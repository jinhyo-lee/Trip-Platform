...
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core"%>    
	...
	<c:set var="detail" value="${roomQnaDetail}"/>
	<form class="needs-validation"  id="qnaFormValue" name="form" method="post" action="roomQnaModify">
		<input type="hidden" name="id" value="${sessionScope.id }">
		<input type="hidden" name="room_qna_id" value="${room_qna_id }">
