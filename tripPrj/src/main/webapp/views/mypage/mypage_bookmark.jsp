          ...
          <div class="col-lg-8 col-md-7 mb-5">
           ...
           <div class="card card-hover card-horizontal border-0 shadow-sm mb-4">
              <div class="card-img-top position-relative">
                ...
                </c:forTokens><a class="stretched-link" href="foodDetail?food_id=${foodbookmark.food_id}&page=1&state=cont"></a>
              ...
              <div class="card-body position-relative pb-3">
                ...
                <h3 class="h6 mb-2 fs-base"><a class="nav-link stretched-link" href="foodDetail?food_id=${foodbookmark.food_id}&page=1&state=cont">${foodbookmark.food_name}</a></h3>
