        ...
        <div class="row">
            ...
            <div class="card card-body border-0 shadow-sm pb-1 me-lg-1">
              ...
              <div class="collapse d-md-block mt-3" id="account-nav">
                <div class="card-nav">
                  ...
                  <a class="card-nav-link active" href="myQnaList"><i class="fi-help opacity-60 me-2"></i>Q&A</a>
          ...
          <div class="col-lg-8 col-md-7 mb-5">
            <div class="d-flex align-items-center justify-content-between mb-4 pb-2">
              <h1 class="h2 mb-0">Q&A</h1><a class="fw-bold text-decoration-none" href="main"><i class="fi-home fs-xs mt-n1 me-2"></i>홈으로</a>
            </div>
             <!-- Food -->
             <c:forEach var="foodQna" items="${foodQnaList}" varStatus="status">
			 <div class="mb-4 pb-4 border-bottom">
			   <div class="d-flex justify-content-between mb-3">
				 ...
				 <div class="d-inline-block">
				   <a style="float: right;" class="text-muted fs-sm" href="foodDetail?food_id=${foodQna.food_id}&page=1&state=cont">&nbsp;해당 게시글로 이동</a>
			     </div>
			   </div>
             ...
             <!-- Place -->
             <c:forEach var="placeQna" items="${placeQnaList}" varStatus="status">
			 <div class="mb-4 pb-4 border-bottom">
			   <div class="d-flex justify-content-between mb-3">
				 <div class="d-flex align-items-center pe-2">
				 ...
				 <div class="d-inline-block">
				   <a style="float: right;" class="text-muted fs-sm" href="placeDetail?place_id=${placeQna.place_id}&page=1&state=cont">&nbsp;해당 게시글로 이동</a>
				 </div>
			   </div>
             ...
             <!-- Room -->
             <c:forEach var="roomQna" items="${roomQnaList}" varStatus="status">
			 <div class="mb-4 pb-4 border-bottom">
			   <div class="d-flex justify-content-between mb-3">
				 <div class="d-flex align-items-center pe-2">
				 ...
				 <div class="d-inline-block">
				   <a style="float: right;" class="text-muted fs-sm" href="roomDetail?room_id=${roomQna.room_id}&page=1&state=cont">&nbsp;해당 게시글로 이동</a>
				 </div>
			    </div>
