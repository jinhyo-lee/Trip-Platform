...
<div class="modal-content" >
  ...
  <div class="modal-body px-sm-5 px-4" id="">
    <form class="needs-validation" action="placeAnswerWrite?place_qna_id=${place_qna_id}" method="post">
     <input type="hidden" name="id" id="id" value="${sessionScope.id }">
     <input type="hidden" name="place_qna_id" id="place_qna_id" value="${place_qna_id}">
