...
<div class="modal-content" >
  ...
  <div class="modal-body px-sm-5 px-4" id="">
    <form class="needs-validation" action="roomAnswerWrite?room_qna_id=${room_qna_id}" method="post">
     <input type="hidden" name="id" id="id" value="${sessionScope.id }">
     <input type="hidden" name="room_qna_id" id="room_qna_id" value="${room_qna_id}">
